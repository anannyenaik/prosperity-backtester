...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("trader", nargs="?", default="strategies/archive/round2/r2_algo_v2_optimised.py", help="Trader python file")
    parser.add_argument("--compare-trader", default="strategies/archive/round2/r2_algo_v2.py", help="Optional comparison trader for the slowest day")
