...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--trader", default="strategies/archive/round2/r2_algo_v2_optimised.py", help="Trader python file")
    parser.add_argument("--baseline", default="strategies/archive/round2/r2_algo_v2.py", help="Baseline trader for the compare bundle")
