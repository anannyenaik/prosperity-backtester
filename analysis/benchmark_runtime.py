...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--trader", default="strategies/archive/round2/r2_algo_v2_optimised.py", help="Replay and compare trader")
    parser.add_argument("--baseline-trader", default="strategies/archive/round2/r2_algo_v2.py", help="Baseline trader for compare and pack cases")
    parser.add_argument("--mc-trader", default="examples/benchmark_trader.py", help="Monte Carlo benchmark trader")
    parser.add_argument("--data-dir", default="data/round2", help="Historical data directory")
    parser.add_argument("--fill-mode", default="base", help="Replay and compare fill mode")
