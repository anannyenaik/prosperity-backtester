...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--trader", default="strategies/r2_algo_v2_optimised.py", help="Replay and compare trader")
    parser.add_argument("--baseline-trader", default="strategies/r2_algo_v2.py", help="Baseline trader for compare and pack cases")
