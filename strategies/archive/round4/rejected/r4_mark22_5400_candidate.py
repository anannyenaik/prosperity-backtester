# Round 4 Mark22 VEV_5400 research candidate.
# Copied from the BS/IV voucher research candidate. Default behaviour remains
# M0_old_zscore. Mark22 production trading was not added because raw label
# controls failed; see docs/ROUND4_MARK22_5400_REPORT.md.
#
# Original BS/IV research candidate notes follow.
# Round 4, BS/IV voucher research candidate.
# Built on top of the FROZEN Hydro v2 + VELVET M4 candidate. Both legs are
# preserved exactly. Vouchers gain a BS/IV module wired through a single
# VOUCHER_OVERLAY config so M0..M7 ablations can be selected without touching
# Hydro/VELVET code.
#
# Voucher modes:
#   M0_old_zscore       (default) frozen ZSCORE_PRIORS leg, unchanged.
#   M1_disabled         all voucher orders dropped.
#   M2_bs_diagnostics   z-score trades; BS state computed but not used.
#   M3_bs_central       BS replacement on VEV_5000/5100/5200 (and 5300 if
#                       VOUCHER_BS["include_5300"]); other strikes disabled.
#   M4_bs_overlay_gate  z-score keeps trading, BS gates orders that disagree
#                       with BS fair by more than gate_edge.
#   M5_bs_central_5400  M3 + cautious BUY-ONLY VEV_5400 leg using BS fair.
#   M6_bs_delta_capped  M5 + hard portfolio net-delta cap (VELVET-equivalent).
#   M7_zscore_shrunk_overlay  z-score with reduced size + BS overlay gate.
#
# All modes share:
