...
_EMPIRICAL_BASE_OVERRIDES: Dict[str, ProductFillConfig] = {
    ...
    "HYDROGEL_PACK": _product_config(
        passive_fill_rate=0.42,
        same_price_queue_share=0.82,
        queue_pressure=1.18,
        missed_fill_probability=0.10,
        passive_adverse_selection_ticks=0.5,
        aggressive_slippage_ticks=0.5,
        aggressive_adverse_selection_ticks=0.5,
        size_slippage_threshold=10,
        size_slippage_rate=0.10,
        size_slippage_power=1.0,
        max_size_slippage_ticks=4.0,
        wide_spread_threshold=18,
        thin_depth_threshold=8,
        regime_overrides={
            "wide_spread": {"passive_fill_rate": 0.34, "queue_pressure": 1.30},
            "thin_depth": {"passive_fill_rate": 0.28, "missed_fill_probability": 0.16},
        },
    ),
    "VELVETFRUIT_EXTRACT": _product_config(
        passive_fill_rate=0.58,
        same_price_queue_share=0.66,
        queue_pressure=0.96,
        missed_fill_probability=0.06,
        passive_adverse_selection_ticks=0.0,
        aggressive_slippage_ticks=0.0,
        ...
        size_slippage_power=1.0,
        max_size_slippage_ticks=3.0,
        wide_spread_threshold=8,
        thin_depth_threshold=18,
        regime_overrides={
            "wide_spread": {"passive_fill_rate": 0.48, "queue_pressure": 1.10},
            "thin_depth": {"passive_fill_rate": 0.42, "missed_fill_probability": 0.10},
        },
    ),
    "VEV_4000": _product_config(
        passive_fill_rate=0.30,
        same_price_queue_share=0.88,
        queue_pressure=1.26,
        ...
        size_slippage_power=1.0,
        max_size_slippage_ticks=4.0,
        wide_spread_threshold=12,
        thin_depth_threshold=6,
    ),
    "VEV_4500": _product_config(
        passive_fill_rate=0.32,
        same_price_queue_share=0.86,
        queue_pressure=1.22,
        missed_fill_probability=0.11,
        passive_adverse_selection_ticks=0.5,
        aggressive_slippage_ticks=0.5,
        aggressive_adverse_selection_ticks=0.5,
        size_slippage_threshold=8,
    ...
    "VEV_5000": _product_config(
        passive_fill_rate=0.44,
        same_price_queue_share=0.78,
        queue_pressure=1.06,
    ...
    "VEV_5100": _product_config(
        passive_fill_rate=0.46,
        same_price_queue_share=0.76,
        queue_pressure=1.02,
        missed_fill_probability=0.08,
        passive_adverse_selection_ticks=0.5,
        aggressive_slippage_ticks=0.0,
    ...
    "VEV_5200": _product_config(
        passive_fill_rate=0.47,
        same_price_queue_share=0.76,
        queue_pressure=1.00,
        missed_fill_probability=0.08,
        passive_adverse_selection_ticks=0.5,
    ...
    "VEV_5400": _product_config(
        passive_fill_rate=0.45,
        same_price_queue_share=0.78,
        queue_pressure=1.05,
        missed_fill_probability=0.08,
        passive_adverse_selection_ticks=0.5,
    ...
    "VEV_5500": _product_config(
        passive_fill_rate=0.42,
        same_price_queue_share=0.80,
        queue_pressure=1.10,
        missed_fill_probability=0.09,
        passive_adverse_selection_ticks=0.5,
        aggressive_slippage_ticks=0.0,
        aggressive_adverse_selection_ticks=0.5,
        size_slippage_threshold=8,
        ...
        size_slippage_power=1.0,
        max_size_slippage_ticks=3.0,
        wide_spread_threshold=9,
        thin_depth_threshold=8,
    ),
    "VEV_6000": _product_config(
        passive_fill_rate=0.20,
        same_price_queue_share=0.92,
        queue_pressure=1.42,
        missed_fill_probability=0.20,
        passive_adverse_selection_ticks=0.5,
        aggressive_slippage_ticks=0.5,
        aggressive_adverse_selection_ticks=0.5,
        size_slippage_threshold=6,
        size_slippage_rate=0.06,
        size_slippage_power=1.0,
        max_size_slippage_ticks=2.0,
        wide_spread_threshold=4,
        thin_depth_threshold=6,
    ),
    "VEV_6500": _product_config(
        passive_fill_rate=0.18,
        same_price_queue_share=0.94,
        queue_pressure=1.50,
        missed_fill_probability=0.22,
        passive_adverse_selection_ticks=0.5,
        aggressive_slippage_ticks=0.5,
        aggressive_adverse_selection_ticks=0.5,
        size_slippage_threshold=6,
